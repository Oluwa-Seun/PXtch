      ...
      <section className="features">
         <div className="features__container container">
            {FeatureData.map((feature, index) => {
               return (
                  <div className="features__feature" key={index} data-aos="zoom-in" data-aos-duration="2000">
                     <div
...
/*
            ...
            <div className="features__feature">
               <div className="features__feature__text">
                  ...
                  >
                     PXTCH products and services are completed and varied for
                     all segments according to user needs
                  </p>
                  <p className="paragraph paragraph--features">
                     PXTCH continues to innovate to develop products that are
